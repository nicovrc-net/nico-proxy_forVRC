            ...
            if (isCache) {
                ...
                if (cacheData != null){
                    ...
                    if (isGetTitle){
                        ...
                        Function.sendHTTPRequest(sock, httpVersion, 200, contentType_text, sendContentEncoding, null, bytes == null ? cacheData.getTitle().getBytes(StandardCharsets.UTF_8) : bytes, isHead, null);
                    } else {
                        if (isHLSDummyPrint){
