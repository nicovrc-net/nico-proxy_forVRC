...
public class GetURL implements Runnable, NicoVRCHTTP {
    ...
    private final Pattern matcher_browser = Pattern.compile("(([fF])irefox|([oO])pera|([sS])ec-([cC])h-([uU])a|[Ss]fari)");
    ...
    private byte[] createDummyHLS(byte[] hls, String cacheId, String hlsOriginUrl){
        ...
        final Matcher matcher = matcher_browser.matcher(httpRequest);
