    ...
    public void run() {
        try {
            ...
            if (apiList.isEmpty()){
                ...
                Function.sendHTTPRequest(sock, httpVersion, 404, contentType_text, null, null, errorAPINotFound, isHead, null);
                return;
            }
            ...
            Function.sendHTTPRequest(sock, httpVersion, code, "application/json; charset=utf-8", null, "*", result.getBytes(StandardCharsets.UTF_8), isHead, null);
            json = null;
