    ...
    public void run() {
        try {
            ...
            if (apiList.isEmpty()){
                ...
                Function.sendHTTPRequest(sock, httpVersion, 404, contentType_text, sendContentEncoding, null, bytes == null ? errorAPINotFound : bytes, isHead, null);
                return;
            }
            ...
            Function.sendHTTPRequest(sock, httpVersion, code, "application/json; charset=utf-8", sendContentEncoding, "*", bytes == null ? result.getBytes(StandardCharsets.UTF_8) : bytes, isHead, null);
            json = null;
            bytes = null;
