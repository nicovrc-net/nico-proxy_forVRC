            ...
            if (json != null){
                if (json.isJsonObject() && json.getAsJsonObject().has("data")){
                    ...
                    request = user_session != null && user_session_secure != null ? HttpRequest.newBuilder()
                            ...
                            .headers("Cookie", "user_session="+user_session+"; user_session_secure="+user_session_secure+"; nicosid="+nicosid + "; AMZN-Token=v2FweIA5a1F4VWtsS0orNDBBNFBwTENodXY1QitwQ3NheUlONDBBNWh3ZVc2eDk0SFRjeGRLQTVyWFQ4TS9waFBwaTlTSVIzNGc5bVllWmpFRXl0NkpBcUlSZ2VUcC95dlNGRXVhR3BsT3lUM0lYMmR0dXFLcFdEcDgxVVlicXoxcUlHemJrdgFiaXZ4HDc3Kzk3Nys5NzcrOU5UMGdFUWp2djcwMDc3Kzn/")
                            .headers("User-Agent", Function.UserAgent)
