...
public class TCPServer extends Thread {
    ...
    public void run() {
        ...
        try (AsynchronousServerSocketChannel server = AsynchronousServerSocketChannel.open()){
            server.bind(new InetSocketAddress(Function.config_httpPort));
    ...
    private void http(AsynchronousSocketChannel ch){
